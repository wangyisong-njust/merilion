...
def main(args):
    ...
    # Load Pruned Model
    #torch.serialization.add_safe_globals([LLMPruner.models.hf_llama.modeling_llama.LlamaForCausalLM])
    ...
    # ✅ Monkey-patch forward to ignore newer transformers argument
    '''
    import types
