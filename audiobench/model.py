...
class Model(object):
    ...
    def get_loss(self, input):
        if 'MERaLiON-2-10B-ASR' in self.model_name or 'MERaLiON-2-3B' in self.model_name :
            from audiobench.model_src.meralion_2 import meralion_2_model_get_loss
            return meralion_2_model_get_loss(self, input)
    
    def get_inputs(self, input):
        if 'MERaLiON-2-10B-ASR' in self.model_name or 'MERaLiON-2-3B' in self.model_name :
            from audiobench.model_src.meralion_2 import meralion_2_model_get_inputs
            return meralion_2_model_get_inputs(self, input)
    ...
    def load_model(self):
        ...
        if self.model_name == "cascade_whisper_large_v3_llama_3_8b_instruct": 
            ...
            from audiobench.model_src.meralion_2 import meralion_2_model_loader
            meralion_2_model_loader(self)

        elif self.model_name == 'MERaLiON-2-10B-ASR':
            from audiobench.model_src.meralion_2 import meralion_2_model_loader
            meralion_2_model_loader(self)

        elif self.model_name == 'MERaLiON-2-10B-ASR-vllm':
            from model_src.meralion_2_vllm import meralion_2_model_loader
            meralion_2_model_loader(self)
        
        elif self.model_name == 'MERaLiON-2-10B-ASR-AWQ':
            from model_src.meralion_2_awq import meralion_2_model_loader
            meralion_2_model_loader(self)
        
        elif 'MERaLiON-2-10B-ASR-BNB' in self.model_name:
    ...
    def generate(self, input):
        ...
        with torch.no_grad():
            if self.model_name == "cascade_whisper_large_v3_llama_3_8b_instruct": 
                ...
                from audiobench.model_src.meralion_2 import meralion_2_model_generation
                return meralion_2_model_generation(self, input)

            elif 'MERaLiON-2-10B-ASR' in self.model_name:
                from audiobench.model_src.meralion_2 import meralion_2_model_generation
                return meralion_2_model_generation(self, input)
                ...
                from model_src.meralion_2_awq import meralion_2_model_generation
                return meralion_2_model_generation(self, input)
