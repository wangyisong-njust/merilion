prune_ckpt_path='Qwen2.5-3B-Instruct-bl-0.3-bl-0.15-c4book'
tune_ckpt_path='Qwen2.5-3B-Instruct-bl-0.3-bl-0.15-c4book-finetuned_twodatasets'
# prune_ckpt_path='tmp'
...
python qwen.py \
      ...
      --save_model \
      --block_wise \
      --block_mlp_layer_start 3 --block_mlp_layer_end 6 \
      --block_attention_layer_start 3 --block_attention_layer_end 6 \
      --max_seq_len 2048 \
      --num_examples 30
...
python post_training_c4zh.py --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin \
 ...
 --lora_r 8 --num_epochs 5 --learning_rate 1e-4 --batch_size 64 
