...
tune_ckpt_path='SmolVLM-500M-Instruct-bl-0_2-8-24-tuned_qlora-r16-llava150K+textvqa_freezevision_combined' # lora_r 16, 4 epochs, learning_rate 4e-4, warm_up 0.05, 10000 llava150K
tune_ckpt_path2='SmolVLM-500M-Instruct-bl-0_2-8-24-tuned_qlora-r16-llava150K+textvqa_freezevision_combined_stage3_moredata' # lora_r 16, 4 epochs, learning_rate 4e-4, warm_up 0.05, 10000 llava150K
...
tune_ckpt_path2='SmolVLM-500M-Instruct-bl-15_stage3_moredata_new' 
...
python post_training_smolvlm_stage2.py --base_model ./vlm_checkpoints/$prune_ckpt_path \
 --tune_dir tune_log/$tune_ckpt_path \
 --output_dir tune_log/$tune_ckpt_path2 \
 --lora_r 4 --num_epochs 5 --learning_rate 2e-4 --batch_size 32
#  --lora_r 4 --num_epochs 5 --learning_rate 2e-4 --batch_size 32

# python post_training_smolvlm_stage2.py --base_model $tune_ckpt_path \
#  --output_dir tune_log/$tune_ckpt_path2 \
#  --lora_r 4 --num_epochs 5 --learning_rate 2e-4 --batch_size 32
