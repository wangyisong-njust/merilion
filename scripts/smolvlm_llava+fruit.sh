...
# tune_ckpt_path='SmolVLM-500M-Instruct-bl-0_2-8-24-tuned_qlora-r16-llava150K' # lora_r 16, 4 epochs, learning_rate 4e-4, warm_up 0.05, 10000 llava150K
...
python post_training_smolvlm_stage2.py --base_model ./vlm_checkpoints/$prune_ckpt_path \
 ...
 --lora_r 16 --num_epochs 4 --learning_rate 2e-4 --batch_size 32 
