...
from LLMPruner.templates.prompts import prompts, zh_prompts
...
def main(args):
    ...
    ppl = PPLMetric(model, tokenizer, ['c4', 'wiki_ch', 'alpaca_cn', 'wikitext2', 'ptb'], args.max_seq_len, device=args.eval_device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_model', type=str, default="deepseek-ai/deepseek-llm-7b-chat", help='base model name')
