...
class MeralionPruner:
    ...
    def __init__(
        ...
        # get_inputs() preprocesses raw audio+instruction dict into model-ready tensors on CUDA
        processed = self.model_parent.get_inputs(example_inputs)
