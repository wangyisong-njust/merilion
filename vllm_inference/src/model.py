...
class Model(object):
    ...
    def __init__(self, model_name_or_path):
        ...
        self.device       = "cuda" # vLLM cannot call torch before loading model with LLM()
    ...
    def load_model(self):
        ...
        elif 'MERaLiON-2-3B' in self.model_name and 'vllm-pruned' in self.model_name:
            from model_src.meralion_2_vllm_pruned import meralion_2_vllm_pruned_model_loader
            meralion_2_vllm_pruned_model_loader(self)
        ...
        elif 'MERaLiON-2-10B-ASR-vllm' in self.model_name:
            from model_src.meralion_2_vllm import meralion_2_model_loader
            meralion_2_model_loader(self)
        
        elif 'MERaLiON-2-quant' in self.model_name:
            from model_src.meralion_2_quant import meralion_2_model_loader
            meralion_2_model_loader(self)
    ...
    def generate(self, input):
        ...
        with torch.no_grad():
            if self.model_name == "cascade_whisper_large_v3_llama_3_8b_instruct": 
                ...
                from model_src.meralion_2_vllm_pruned import meralion_2_vllm_pruned_model_generation
                return meralion_2_vllm_pruned_model_generation(self, input)
                ...
                from model_src.meralion_2_quant import meralion_2_model_generation
                return meralion_2_model_generation(self, input)
